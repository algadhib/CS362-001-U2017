...
public class TimeTableTest {
	...
	@Test
	 ...
	 assertTrue(appt_1.getValid());
	 assertTrue(appt_2.getValid());
	 assertTrue(appt_3.getValid());

	  //create first and last days
	  //GregorianCalendar today = new GregorianCalendar(thisYear,thisMonth,thisDay);
	  GregorianCalendar first = new GregorianCalendar(2017, 6, 6);
	  GregorianCalendar last = new GregorianCalendar(2017, 6, 7);

	  try	{
			LinkedList<CalDay> updatedList = timetable.getApptRange(ApptsList, first, last);
			assertEquals(1, updatedList.size());
			assertEquals(-1, updatedList.get(0).getSizeAppts());
	  } catch(NullPointerException e)	{
	...
	int [] arr = {1,2,3};
	appt_1.setRecurrence(arr, 1, 1, -1);
	appt_2.setRecurrence(arr, 1, 1, -1);
	appt_3.setRecurrence(arr, 1, 1, -1);
	 ...
	 assertTrue(appt_3.getValid());
	  ...
	  //GregorianCalendar today = new GregorianCalendar(thisYear,thisMonth,thisDay);
	  GregorianCalendar first = new GregorianCalendar(2017, 6, 6);
	  GregorianCalendar last = new GregorianCalendar(2017, 6, 9);
	...
	int [] arr = {1,2,3};
	appt_1.setRecurrence(arr, 2, 1, -1);
	appt_2.setRecurrence(arr, 2, 1, -1);
	appt_3.setRecurrence(arr, 2, 1, -1);
	...
	int [] arr = new int[0];
	appt_1.setRecurrence(arr, 3, 1, -1);
	appt_2.setRecurrence(arr, 3, 1, -1);
	appt_3.setRecurrence(arr, 3, 1, -1);
	 ...
	 assertTrue(appt_3.getValid());
	  ...
	  //try	{
			...
			assertEquals(3, updatedList.size());
			assertEquals(-1, updatedList.get(0).getSizeAppts());
			assertEquals(-1, updatedList.get(1).getSizeAppts());
			assertEquals(-1, updatedList.get(2).getSizeAppts());
	  //} catch(NullPointerException e)	{}
	...
	assertTrue(appt_2.isRecurring());
	 ...
	 // try	{
			LinkedList<CalDay> updatedList = timetable.getApptRange(ApptsList, first, last);
			assertEquals(32, updatedList.size());
			assertEquals(-1, updatedList.get(0).getSizeAppts());
			assertEquals(-1, updatedList.get(1).getSizeAppts());
			assertEquals(-1, updatedList.get(2).getSizeAppts());
	 // } catch(NullPointerException e)	{}
	...
	@Test
	 public void test37()  throws Throwable  {
	  ...
	  int [] arr = {1,2,3,4,5,6,7,8,9};
	  appt_1.setRecurrence(arr, 1, 1, 100);
	...
	int [] arr_2 = {1,2,3};
	appt_2.setRecurrence(arr_2, 3, 3, 100);
